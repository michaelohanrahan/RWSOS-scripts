...
# model_runs = dict(
#     kin = R'p:\11205237-grade\wflow\wflow_rhine_julia\wflow_rhine_202210_smoothriver\wflow_updated\routing_kin\output.csv',
#     loc1d = R'p:\11205237-grade\wflow\wflow_rhine_julia\wflow_rhine_202210_smoothriver\wflow_updated\routing_lociner_sub\output.csv',
#     loc2d = R'p:\11205237-grade\wflow\wflow_rhine_julia\wflow_rhine_202210_smoothriver\wflow_updated\routing_lociner_1d2d\output.csv',
#     # fld1d = R'P:\11209265-grade2023\wflow\wflow_rhine_julia\wflow_rhine_202301_floodplain1d\routing_floodplain1d_2014_latest_20230216_full\output.csv',
#     fld1d = R'P:\11209265-grade2023\wflow\wflow_rhine_julia\wflow_rhine_202301_floodplain1d\routing_fld1d_2014_latest_20230216_rivWD\output.csv',
#     # RD2 = R'P:\11209265-grade2023\wflow\wflow_rhine_julia\wflow_rhine_202301_floodplain1d\routing_fld1d_2014_latest_20230216_RD2\output.csv',
#     # RD2ST2 = R'P:\11209265-grade2023\wflow\wflow_rhine_julia\wflow_rhine_202301_floodplain1d\routing_fld1d_2014_latest_20230216_RD2_ST2\output.csv',
...
# # model_runs = {
# #     "kin":          "../routing_kin/output.csv",
# #     "loc1d":  "../routing_lociner_avg/output.csv",
# #     # "lociner_sub":  "../routing_lociner_sub/output.csv",
# #     "loc2d":         "../routing_lociner_1d2d/output.csv",
# #     "HBV":  R"p:\11205237-grade\climate_data\KNMI_scenarios_preparation\CMIP6_datasets_prepared_forWflow\2022-11-hbv_runs\output\Rhine\020151231_HBV_RHINE.csv"
# # }

# idx_start = 365
# basel_cor = False
# Folder_plots = "../_figures/"
...
# colors = [
#     '#a6cee3','#1f78b4','#b2df8a','#33a02c','orange', '#fb9a99','#e31a1c',
...
#         basel_diff = basel_runs.Q.sel(runs="Obs.") - basel_runs.Q

#         basel_diff.loc[dict(runs="HBV_Lobith")] = 0.0
