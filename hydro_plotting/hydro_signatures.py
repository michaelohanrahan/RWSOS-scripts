...
def plot_hydro(
    ...
    labels, colors, Folder_out, station_name, station_id, lw = 0.8, fs = 8, save=False
    ):
    ...
    if save:
        plt.savefig(os.path.join(Folder_out, f"hydro_{station_name}_{station_id}.png"), dpi=300)
        plt.close()